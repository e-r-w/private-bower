...
describe('Main', function() {
    var applicationCons, applicationMock;
    ...
    beforeEach(function() {
        ...
        applicationCons = jasmine.createSpy('application').and.returnValue(applicationMock);
        ...
        mockery.registerMock('./utils.js', utilsMock);
        mockery.registerMock('./application.js', applicationCons);
        mockery.registerMock('./configurationManager.js', configurationManagerMock);
    ...
    describe('start()', function() {
        ...
        it('should create the Application and pass the serverApp', function() {
            main.start();
            
            expect(applicationCons).toHaveBeenCalledWith(expressMock, expressCons.static);
        });
        
        it('should loadControllers on Application', function() {
            main.start();
            
            expect(applicationMock.loadControllers).toHaveBeenCalledWith('controllers');
        });
